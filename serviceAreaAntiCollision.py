...
from .serviceAreaAntiCollision_dialog import ServiceAreaAntiCollisionDialog
...
from  Hqgis.ServiceAreaAntiCollisionProvider import ServiceAreaAntiCollisionProvider
import math
import processing  # Importar la librería de procesamiento

class ServiceAreaAntiCollision:
    def __init__(self, iface):
        self.provider = ServiceAreaAntiCollisionProvider()
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ServiceAreaAntiCollision_{}.qm'.format(locale))
        ...
        self.dlg = ServiceAreaAntiCollisionDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&ServiceAreaAntiCollision')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'ServiceAreaAntiCollision')
        self.toolbar.setObjectName(u'ServiceAreaAntiCollision')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ServiceAreaAntiCollision', message)
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginWebMenu(
                self.tr(u'&ServiceAreaAntiCollision'),
                action)
